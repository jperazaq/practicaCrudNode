...
mongoose.connect('mongodb+srv://julio:papayaso07@cluster0.nzdgq.mongodb.net/<dbname>?retryWrites=true&w=majority', { useUnifiedTopology: true, useNewUrlParser: true }).then(db => console.log("Se conecto bien SUPER GENIO")).catch(err => console.log(err));
